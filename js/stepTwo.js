...
const radio_inputStoreBoxsize = document.querySelector(
    ".box__inputStoreRadio__lists"
);
radio_inputStoreBoxsize.addEventListener("change", (e) => {
    const selected = document.querySelectorAll(
        ".box__inputStoreRadio__lists > li > label > input"
    );
    const black = "#000000";
    const selectedColor = "#f18b24";
...
const radio_outputBoxsize = document.querySelector(
    ".outputBoxsize__Radio__lists"
);
radio_outputBoxsize.addEventListener("change", (e) => {
    const selected = document.querySelectorAll(
        ".outputBoxsize__Radio__lists > li > label > input"
    );
    const black = "#000000";
    const selectedColor = "#f18b24";
